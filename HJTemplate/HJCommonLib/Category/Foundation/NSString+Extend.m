...
// [json] to Java
- (NSString *)utf8Str {
//    NSString *utf8Str = (__bridge_transfer  NSString*) CFURLCreateStringByAddingPercentEscapes(kCFAllocatorDefault, (__bridge CFStringRef)jsonStr, NULL, (__bridge CFStringRef)@"!*'();:@&=+$,/?%#[]", kCFStringEncodingUTF8 );
    NSString *formatStr = @"!*'();:@&=+$,/?%#[]{}\"";
    NSCharacterSet *characterAllow = [[NSCharacterSet characterSetWithCharactersInString:formatStr] invertedSet];
    NSString *temp = [self stringByAddingPercentEncodingWithAllowedCharacters:characterAllow];
    return temp;
}
- (NSString *)urlEncode {
